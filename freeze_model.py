...
parser.add_argument(
    "--config", dest="config", help="catalyst config file", required=True
)
parser.add_argument(
    "--state", dest="state", help="catalyst checkpoint file", required=True
)
parser.add_argument(
    "--out", dest="out", help="file to use for storing traced model", required=True
)
parser.add_argument(
    "--shapes",
    dest="shape",
    help="shapes to use as input to a model",
    required=True,
    type=int,
    nargs="+",
)
parser.add_argument(
    "--dtype", dest="dtype", help="tensor type", type=str, default="float"
)
